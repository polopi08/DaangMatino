...
export default class RealtimeClient {
     ...
     *
     * @param endPoint The string WebSocket endpoint, ie, "ws:
     * @param httpEndpoint The string HTTP endpoint, ie, "https:
     ...
     * @param options.workerUrl The URL of the worker script. Defaults to https:
     */
