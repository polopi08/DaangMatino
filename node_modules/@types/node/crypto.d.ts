...
declare module "crypto" {
     ...
     *
     * `<keygen>` is deprecated since [HTML 5.2](https:
    ...
    class KeyObject {
         ...
         * a PKCS#8 key. See [RFC 5208](https:
         ...
         * type, value, and parameters. This method is not [constant time](https:
    ...
    class DiffieHellman {
         ...
         *
         * This function is a thin wrapper around [`DH_generate_key()`](https:
     ...
     * ```
     * The name (e.g. `'modp1'`) is taken from [RFC 2412](https:
     * ```bash
     ...
     * random and at least 16 bytes long. See [NIST SP 800-132](https:
     *
     ...
     * implementation avoids [modulo bias](https:
     *
     * The range (`max - min`) must be less than 2**48. `min` and `max` must
     * be [safe integers](https:
     *
    ...
    /**
     * Provides an asynchronous [scrypt](https:
    ...
    /**
     * Provides a synchronous [scrypt](https:
     * key derivation function that is designed to be expensive computationally and
     * memory-wise in order to make brute-force attacks unrewarding.
     *
     * The `salt` should be as unique as possible. It is recommended that a salt is
     ...
     * comparing HMAC digests or secret values like authentication cookies or [capability urls](https:
     *
     ...
     * @param [outputEncoding='hex'] [Encoding](https:
     */
     ...
     * be passed to the callback as an [ArrayBuffer](https:
     ...
     *
     * The successfully generated `derivedKey` will be returned as an [ArrayBuffer](https:
     *
    ...
    /**
     * Generates a random [RFC 4122](https:
    ...
    class X509Certificate {
         ...
         * property at the two-character sequence `', '` (see [CVE-2021-44532](https:
         ...
         * If the `'subject'` option is undefined or set to `'default'`, the certificate
         * subject is only considered if the subject alternative name extension either does
         * not exist or does not contain any DNS names. This behavior is consistent with [RFC 2818](https:
         *
         * If the `'subject'` option is set to `'always'` and if the subject alternative
    ...
    namespace webcrypto {
        ...
        interface CryptoKeyConstructor {
            ...
            (_: { readonly _: unique symbol }): never; 
            readonly length: 0;
        ...
        interface SubtleCrypto {
             ...
             * - `'HKDF'`
             * - `'PBKDF2'`
             * @param keyUsages See {@link https:
             * @since v15.0.0
             */
            deriveKey(
                algorithm: EcdhKeyDeriveParams | HkdfParams | Pbkdf2Params,
             ...
             * JavaScript object conforming to the {@link https:
