...
declare module "http" {
     ...
     * ```
     *
     * `options` in [`socket.connect()`](https:
     *
     ...
     * } catch (err) {
     *   console.error(err instanceof TypeError); 
     *   console.error(err.code === 'ERR_HTTP_INVALID_HEADER_VALUE'); 
     *   console.error(err.message); 
     * }
     *
     * try {
    ...
    /**
     * A browser-compatible implementation of [WebSocket](https:
     * @since v22.5.0
     */
