/**
 * The `node:v8` module exposes APIs that are specific to the version of [V8](https:
 *
 * ```js
...
declare module "v8" {
     ...
     * [`cppgc::HeapStatistics`](https:
     * object. See the [V8 documentation](https:
     ...
     * V8 [`GetHeapSpaceStatistics`](https:
     * next.
     *
    ...
    /**
     * This is similar to the [`queryObjects()` console API](https:
     ...
     * V8 [`GetHeapCodeAndMetadataStatistics`](https:
     ...
     * `limit` must be a positive integer. See [`--heapsnapshot-near-heap-limit`](https:
