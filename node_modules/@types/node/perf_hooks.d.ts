/**
 * This module provides an implementation of a subset of the W3C [Web Performance APIs](https:
 * Node.js-specific performance measurements.
 *
 * Node.js supports the following [Web Performance APIs](https:
 *
 * * [High Resolution Time](https:
 * * [Performance Timeline](https:
 * * [User Timing](https:
 * * [Resource Timing](https:
 *
 * ```js
...
declare module "perf_hooks" {
    ...
    interface Performance {
         ...
         * @param timingInfo [Fetch Timing Info](https:
         ...
         * @param bodyInfo [Fetch Response Body Info](https:
         ...
         * [`window.performance.toJSON`](https:
         * @since v16.1.0
         */
        toJSON(): any;
    }
