 ...
 *
 * There are many stream objects provided by Node.js. For instance, a [request to an HTTP server](https:
 * and [`process.stdout`](https:
 *
 * Streams can be readable, writable, or both. All streams are instances of [`EventEmitter`](https:
 *
...
declare module "stream" {
    ...
    namespace Stream {
        ...
        class Readable extends Stream implements NodeJS.ReadableStream {
            ...
            /**
             * Becomes `true` when [`'end'`](https:
             * @since v12.9.0
             */
            readonly readableEnded: boolean;
            /**
             * This property reflects the current state of a `Readable` stream as described
             * in the [Three states](https:
             * @since v9.4.0
             */
         ...
         *
         * The `finished` API provides [`promise version`](https:
         *
         ...
         * ```
         *
         * The `pipeline` API provides a [`promise version`](https:
         *
