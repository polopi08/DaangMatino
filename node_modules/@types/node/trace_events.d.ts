 ...
 * * `node.async_hooks`: Enables capture of detailed [`async_hooks`](https:
 * The [`async_hooks`](https:
 ...
 * * `node.perf`: Enables capture of [Performance API](https:
 ...
 *
 * The features from this module are not available in [`Worker`](https:
 * @experimental
 * @see [source](https:
 */
