...
declare module "fs" {
    ...
    export class Dir implements AsyncIterable<Dirent> {
        ...
        closeSync(): void;
        /**
         * Asynchronously read the next directory entry via [`readdir(3)`](http:
         *
     ...
     * given to the completion callback.
     *
     * See the POSIX [`ftruncate(2)`](http:
     *
    ...
    /**
     * Creates a new link from the `existingPath` to the `newPath`. See the POSIX [`link(2)`](http:
     * a possible
     * exception are given to the completion callback.
     * @since v0.1.31
     */
     ...
     *
     * This function behaves like [`realpath(3)`](http:
     *
     * 1. No case conversion is performed on case-insensitive file systems.
     * 2. The maximum number of symbolic links is platform-independent and generally
     * (much) higher than what the native [`realpath(3)`](http:
     *
    ...
    /**
     * Asynchronous file open. See the POSIX [`open(2)`](http:
     *
     ...
     * by [Naming Files, Paths, and Namespaces](https:
     * a colon, Node.js will open a file system stream, as described by [this MSDN page](https:
     *
     ...
     * Refer to the POSIX [`fsync(2)`](http:
     ...
     * at the current position. See [`pwrite(2)`](http:
     *
     ...
     * \[0, [`Number.MAX_SAFE_INTEGER`](https:
     ...
     * operating system's synchronized I/O completion state. Refer to the POSIX [`fdatasync(2)`](http:
     * than a possible
     * exception are given to the completion callback.
     * @since v0.1.96
     */
    ...
    /**
     * Synchronously open a directory. See [`opendir(3)`](http:
     *
    ...
    /**
     * Asynchronously open a directory. See the POSIX [`opendir(3)`](http:
     * more details.
     *
     * Creates an `fs.Dir`, which contains all further functions for reading from
     * and cleaning up the directory.
