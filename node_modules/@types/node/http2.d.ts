/**
 * The `node:http2` module provides an implementation of the [HTTP/2](https:
...
declare module "http2" {
    ...
    export interface Http2Stream extends stream.Duplex {
         ...
         * ```js
         * import http2 from 'node:http2';
         * const client = http2.connect('http:
    ...
    export interface ClientHttp2Session extends Http2Session {
         ...
         * ```js
         * import http2 from 'node:http2';
         * const clientSession = http2.connect('https:
         * const {
         *   HTTP2_HEADER_PATH,
         *   HTTP2_HEADER_STATUS,
         * } = http2.constants;
    ...
    > extends Http2Session {
        ...
        /**
         * Submits an `ALTSVC` frame (as defined by [RFC 7838](https:
         *
         * ```js
         * import http2 from 'node:http2';
         *
        ...
        /**
         * Submits an `ORIGIN` frame (as defined by [RFC 8336](https:
         ...
         * });
         * server.on('session', (session) => {
         *   session.origin('https:
         * });
         * ```
         *
         * When a string is passed as an `origin`, it will be parsed as a URL and the
         * origin will be derived. For instance, the origin for the HTTP URL `'https:
         * string
         * cannot be parsed as a URL or if a valid origin cannot be derived.
         *
     ...
     * HTTP/2 settings as specified in the [HTTP/2](https:
     ...
     *
     * Since there are no browsers known that support [unencrypted HTTP/2](https:
     * communicating
     ...
     * ```
     * @since v8.4.0
     * @param authority The remote HTTP/2 server to connect to. This must be in the form of a minimal, valid URL with the `http:
