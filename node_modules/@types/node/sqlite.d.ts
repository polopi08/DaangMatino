...
declare module "node:sqlite" {
    ...
    interface DatabaseSyncOptions {
         ...
         * [double-quoted string literals](https:
    ...
    interface FunctionOptions {
        /**
         * If `true`, the [`SQLITE_DETERMINISTIC`](https:
         * set on the created function.
         * @default false
         */
        deterministic?: boolean | undefined;
        /**
         * If `true`, the [`SQLITE_DIRECTONLY`](https:
    ...
    /**
     * This class represents a single [connection](https:
    ...
    class DatabaseSync implements Disposable {
         ...
         * A SQLite database can be stored in a file or completely [in memory](https:
         ...
         * [`sqlite3_create_window_function()`](https:
         *
         ...
         * open. This method is a wrapper around [`sqlite3_close_v2()`](https:
         * @since v22.5.0
         */
        close(): void;
        /**
         * Loads a shared library into the database connection. This method is a wrapper
         * around [`sqlite3_load_extension()`](https:
        ...
        /**
         * This method is a wrapper around [`sqlite3_db_filename()`](https:
         * @since v24.0.0
         * @param dbName Name of the database. This can be `'main'` (the default primary database) or any other
         * database that has been added with [`ATTACH DATABASE`](https:
         ...
         * file. This method is a wrapper around [`sqlite3_exec()`](https:
         * @since v22.5.0
         ...
         * wrapper around [`sqlite3_create_function_v2()`](https:
         * @since v22.13.0
         * @param name The name of the SQLite function to create.
         ...
         * [Type conversion between JavaScript and SQLite](https:
         ...
         * is a wrapper around [`sqlite3_get_autocommit()`](https:
         * @since v24.0.0
         */
        ...
        open(): void;
        /**
         * Compiles a SQL statement into a [prepared statement](https:
         * around [`sqlite3_prepare_v2()`](https:
         * @since v22.5.0
         ...
         * [`sqlite3session_create()`](https:
         * [`sqlite3session_attach()`](https:
    ...
    interface Session {
         ...
         * [`sqlite3session_changeset()`](https:
         ...
         * [Changesets and Patchsets](https:
         * in the documentation of SQLite. An exception is thrown if the database or the session is not open. This method is a
         * wrapper around
         * [`sqlite3session_patchset()`](https:
    ...
    interface StatementColumnMetadata {
         ...
         * result of [`sqlite3_column_table_name()`](https:
         */
        table: string | null;
        /**
         ...
         * result of [`sqlite3_column_decltype()`](https:
         */
        type: string | null;
    }
    interface StatementResultingChanges {
         ...
         * This property is the result of [`sqlite3_changes64()`](https:
         */
        changes: number | bigint;
        /**
         * The most recently inserted rowid.
         * This field is either a number or a `BigInt` depending on the prepared statement's configuration.
         * This property is the result of [`sqlite3_last_insert_rowid()`](https:
         */
        lastInsertRowid: number | bigint;
    }
    /**
     * This class represents a single [prepared statement](https:
     ...
     * times with different bound values. Parameters also offer protection against [SQL injection](https:
     * preferred
    ...
    class StatementSync {
         ...
         * returns an empty array. The prepared statement [parameters are bound](https:
         ...
         * returns `undefined`. The prepared statement [parameters are bound](https:
         ...
         * objects. If the prepared statement does not return any results, this method
         * returns an empty iterator. The prepared statement [parameters are bound](https:
         * the values in `namedParameters` and `anonymousParameters`.
         * @since v22.13.0
         ...
         * resulting changes. The prepared statement [parameters are bound](https:
         * values in `namedParameters` and `anonymousParameters`.
         * @since v22.5.0
         * @param namedParameters An optional object used to bind named parameters. The keys of this object are used to configure the mapping.
         * @param anonymousParameters Zero or more values to bind to anonymous parameters.
         ...
         * wrapper around [`sqlite3_sql()`](https:
         * @since v22.5.0
         */
    ...
    interface BackupOptions {
         ...
         * database that have been added with [`ATTACH DATABASE`](https:
         * @default 'main'
         */
     ...
     * [`sqlite3_backup_init()`](https:
     * [`sqlite3_backup_step()`](https:
     * and [`sqlite3_backup_finish()`](https:
     *
