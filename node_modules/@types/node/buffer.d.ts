 ...
 *
 * The `Buffer` class is a subclass of JavaScript's [`Uint8Array`](https:
 * extends it with methods that cover additional use cases. Node.js APIs accept
 * plain [`Uint8Array`](https:
 *
...
declare module "buffer" {
    ...
    export class Blob {
        ...
        /**
         * Returns a promise that fulfills with an [ArrayBuffer](https:
         * the `Blob` data.
         * @since v15.7.0, v14.18.0
         */
    ...
    global {
        ...
        interface BufferConstructor {
             ...
             * This is not the same as [`String.prototype.length`](https:
             ...
             *
             * When `string` is a
             * `Buffer`/[`DataView`](https:
             * Reference/Global_Objects/TypedArray)/[`ArrayBuffer`](https:
        ...
        interface Buffer {
            ...
            /**
             * Returns a JSON representation of `buf`. [`JSON.stringify()`](https:
             ...
             *
             * [`TypedArray.prototype.set()`](https:
             ...
             * behavior matches [`String.prototype.indexOf()`](https:
             *
             * ```js
             * import { Buffer } from 'node:buffer';
             *
             ...
             * This behavior matches [`String.prototype.lastIndexOf()`](https:
             *
             * ```js
             * import { Buffer } from 'node:buffer';
             *
