...
declare module "assert" {
    ...
    namespace assert {
         ...
         *
         * Tests shallow, coercive inequality with the [`!=` operator](https:
         ...
         *
         * If specified, `error` can be a [`Class`](https:
         * [`RegExp`](https:
         ...
         * ```
         *
         * Validate error message using [`RegExp`](https:
         *
         ...
         * function does not return a promise, `assert.rejects()` will return a rejected `Promise` with an [ERR_INVALID_RETURN_VALUE](https:
         ...
         * rejected `Promise` with an [ERR_INVALID_RETURN_VALUE](https:
