...
declare module "worker_threads" {
     ...
     *
     * This implementation matches [browser `MessagePort`](https:
     * @since v10.5.0
     */
    class MessagePort extends EventEmitter {
         ...
         * the [HTML structured clone algorithm](https:
         *
         ...
         * * `value` may contain [`WebAssembly.Module`](https:
         ...
         * ```
         *
         * `transferList` may be a list of [`ArrayBuffer`](https:
         * After transferring, they are not usable on the sending side of the channel
         * anymore (even if they are not contained in `value`). Unlike with `child processes`, transferring handles such as network sockets is currently
         * not supported.
         *
         * If `value` contains [`SharedArrayBuffer`](https:
     ...
     * inherits from its global `Object` class. Objects passed to the [`port.onmessage()`](https:
     * target context
     * and inherit from its global `Object` class.
     *
     * However, the created `MessagePort` no longer inherits from [`EventTarget`](https:
     * [`port.onmessage()`](https:
     * events using it.
     * @since v11.13.0
