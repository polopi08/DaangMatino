...
declare module "net" {
    ...
    interface ServerOpts {
         ...
         * @default See [stream.getDefaultHighWaterMark()](https:
    ...
    class Server extends EventEmitter {
         ...
         *
         * All {@link Socket} are set to `SO_REUSEADDR` (see [`socket(7)`](https:
         * details).
         *
     ...
     * connection is half-closed (non-readable but still writable). See `'end'` event and [RFC 1122](https:
     *
     ...
     * address in [dot-decimal notation](https:
     *
     * ```js
     * net.isIP('::1'); 
     * net.isIP('127.0.0.1'); 
     * net.isIP('127.000.000.001'); 
     * net.isIP('127.0.0.1/24'); 
     * net.isIP('fhqwhgads'); 
     * ```
     * @since v0.3.0
     */
    ...
    /**
     * Returns `true` if `input` is an IPv4 address in [dot-decimal notation](https:
     * leading zeroes. Otherwise, returns `false`.
     *
     * ```js
     * net.isIPv4('127.0.0.1'); 
     * net.isIPv4('127.000.000.001'); 
     * net.isIPv4('127.0.0.1/24'); 
     * net.isIPv4('fhqwhgads'); 
     * ```
     * @since v0.3.0
     */
