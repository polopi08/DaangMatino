...
declare module "vm" {
     ...
     * [`eval()`](https:
     * local scope, so the value `localVar` is changed. In this way `vm.runInThisContext()` is much like an [indirect `eval()` call](https:
     *
     ...
     * ECMAScript modules in VM contexts. It is the counterpart of the `vm.Script` class that closely mirrors [Module Record](https:
    ...
    class Module {
         ...
         *
         * Corresponds to the `[[RequestedModules]]` field of [Cyclic Module Record](https:
         ...
         *
         * Corresponds to the `[[EvaluationError]]` field of [Cyclic Module Record](https:
         ...
         *
         * Corresponds to the [GetModuleNamespace](https:
         * specification.
         */
        namespace: Object;
        /**
         ...
         *
         * Other than `'errored'`, this status string corresponds to the specification's [Cyclic Module Record](https:
         ...
         *
         * Corresponds to the [Evaluate() concrete method](https:
         ...
         * specification.
         *
         * Corresponds to the [Link() concrete method](https:
         * the ECMAScript specification.
         */
     ...
     * flag enabled.
     *
     * The `vm.SourceTextModule` class provides the [Source Text Module Record](https:
     ...
     * flag enabled.
     *
     * The `vm.SyntheticModule` class provides the [Synthetic Module Record](https:
