 ...
 *
 * Node.js supports the creation of [single executable applications](https:
 ...
 *    * `--sentinel-fuse NODE_SEA_FUSE_fce680ab2cc467b6e072b8b5df1996b2` \- The [fuse](https:
 * injected.
...
declare module "node:sea" {
    ...
    /**
     * Similar to `sea.getAsset()`, but returns the result in a [`Blob`](https:
     * An error is thrown when no matching asset can be found.
     * @since v20.12.0
     */
