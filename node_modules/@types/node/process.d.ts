    ...
    global {
        ...
        namespace NodeJS {
            ...
            interface ProcessFeatures {
                 ...
                 * [loading ECMAScript modules using `require()`](https:
                 * @since v22.10.0
                 */
            ...
            interface Process extends EventEmitter {
                 ...
                 *
                 * The `flags` argument is an integer that allows to specify dlopen behavior. See the `[os.constants.dlopen](https:
                ...
                getgid?: () => number;
                /**
                 * The `process.setgid()` method sets the group identity of the process. (See [`setgid(2)`](http:
                ...
                getuid?: () => number;
                /**
                 * The `process.setuid(id)` method sets the user identity of the process. (See [`setuid(2)`](http:
                 ...
                 * the process. (See [`geteuid(2)`](http:
                 *
                 * ```js
                 * import process from 'node:process';
                 *
                 ...
                 * of the Node.js process. (See [`getegid(2)`](http:
                 *
                 * ```js
                 * import process from 'node:process';
                 *
                ...
                /**
                 * The `process.sourceMapsEnabled` property returns whether the [Source Map v3](https:
                 * @since v20.7.0
                 * @experimental
                 */
                readonly sourceMapsEnabled: boolean;
                /**
                 * This function enables or disables the [Source Map v3](https:
                 * stack traces.
                 *
                 ...
                 *
                 * Signal names are strings such as `'SIGINT'` or `'SIGHUP'`. See `Signal Events` and [`kill(2)`](http:
                 *
                 ...
                 * Android operating system. However, Android support in Node.js [is experimental](https:
                 * @since v0.1.16
                 */
                 ...
                 *
                 * See [`uv_get_constrained_memory`](https:
                 * information.
                 ...
                 * See [`uv_get_available_memory`](https:
                 * @since v20.13.0
                 */
                ...
                /**
                 * This API is available through the [--permission](https:
                 *
                 * `process.permission` is an object whose methods are used to manage permissions for the current process.
                 * Additional documentation is available in the [Permission Model](https:
                 * @since v20.0.0
                 */
                 ...
                 * Additional documentation is available in the [report documentation](https:
                 * @since v11.8.0
                 */
