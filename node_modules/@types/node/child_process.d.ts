 ...
 * a manner that is similar, but not identical, to [`popen(3)`](http:
...
declare module "child_process" {
    ...
    class ChildProcess extends EventEmitter {
         ...
         * argument is given, the process will be sent the `'SIGTERM'` signal. See [`signal(7)`](http:
         * returns `true` if [`kill(2)`](http:
         *
         * ```js
         * import { spawn } from 'node:child_process';
         * const grep = spawn('grep', ['ssh']);
         ...
         * @since v0.5.9
         * @param sendHandle `undefined`, or a [`net.Socket`](https:
     ...
     * directly by the shell and special characters (vary based on [shell](https:
