...
declare module "module" {
    ...
    namespace Module {
        ...
        /**
         * Enable [module compile cache](https:
        ...
        /**
         * Flush the [module compile cache](https:
        ...
        /**
         * @since v22.8.0
         * @return Path to the [module compile cache](https:
         ...
         * see [type-stripping](https:
         * When mode is `'transform'`, it also transforms TypeScript features to JavaScript,
         * see [transform TypeScript features](https:
