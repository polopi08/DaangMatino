 ...
 *
 * The WASI API provides an implementation of the [WebAssembly System Interface](https:
...
declare module "wasi" {
    ...
    class WASI {
         ...
         *
         * `start()` requires that `instance` exports a [`WebAssembly.Memory`](https:
         ...
         *
         * `initialize()` requires that `instance` exports a [`WebAssembly.Memory`](https:
         ...
         * of a [`WebAssembly.Instance`](https:
         * @since v13.3.0, v12.16.0
         */
