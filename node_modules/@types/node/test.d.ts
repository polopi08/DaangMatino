...
declare module "node:test" {
    ...
    interface RunOptions {
         ...
         * [test runner execution model](https:
         * @since v23.0.0
         * @default process.cwd()
         */
        ...
        >
    {
         ...
         * the [`--test-update-snapshots`](https:
    ...
    class MockTracker {
         ...
         * [`--experimental-test-module-mocks`](https:
         * command-line flag.
         *
...
declare module "node:test/reporters" {
    ...
    /**
     * The `tap` reporter outputs the test results in the [TAP](https:
     * @since v20.0.0
     */
     ...
     * [`--experimental-test-coverage`](https:
     * @since v22.0.0
     */
