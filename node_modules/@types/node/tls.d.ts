...
declare module "tls" {
    ...
    class TLSSocket extends net.Socket {
         ...
         * ```
         *
         * See [SSL\_CIPHER\_get\_name](https:
         * @since v0.11.4
         */
         ...
         * to implement the `tls-unique` channel binding from [RFC 5929](https:
         * @since v9.9.0
         ...
         * * `'TLSv1.3'`
         *
         * See the OpenSSL [`SSL_get_version`](https:
         * @since v5.7.0
         */
        ...
        /**
         * See [SSL\_get\_shared\_sigalgs](https:
         * @since v12.11.0
         ...
         * ```
         *
         * See the OpenSSL [`SSL_export_keying_material`](https:
         * information.
     ...
     *
     * Returns [Error](https:
     * failure. On success, returns [undefined](https:
     *
     ...
     * was present (see [CVE-2021-44531](https:
     ...
     * [Modifying the default TLS cipher suite](https:
     *
