...
declare module "url" {
     ...
     * strings. It is prone to security issues such as [host name spoofing](https:
     ...
     * @param [slashesDenoteHost=false] If `true`, the first token after the literal string `
     * result would be `{host: 'foo', pathname: '/bar'}` rather than `{pathname: '
     */
     ...
     * Standard. [Examples of parsed URLs](https:
    ...
    class URL {
         ...
         *
         * ```js
         * const isValid = URL.canParse('/foo', 'https:
         *
    ...
    class URLSearchParams implements Iterable<[string, string]> {
         ...
         * with a [stable sorting algorithm](https:
