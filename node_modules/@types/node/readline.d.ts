/**
 * The `node:readline` module provides an interface for reading data from a [Readable](https:
 * (such as [`process.stdin`](https:
 *
...
declare module "readline" {
    ...
    export interface ReadLineOptions {
         ...
         * (which may be reasonable for [reading files](https:
         * @default 100
         */
     ...
     * will not terminate until it receives an [EOF character](https:
    ...
    /**
     * The `readline.clearLine()` method clears current line of given [TTY](https:
    ...
    /**
     * The `readline.clearScreenDown()` method clears the given [TTY](https:
