...
declare module "util" {
     ...
     * that the two styles are [semantically incompatible](https:
     *
     ...
     * will return its value, see [Custom promisified functions](https:
     *
     ...
     * ```
     *
     * The full list of formats can be found in [modifiers](https:
    ...
    /**
     * An implementation of the [WHATWG Encoding Standard](https:
     *
     * ```js
    ...
    TypeScript does not have exact types for objects: https:
    ...
    */
    ...
    /**
     * An implementation of [the MIMEType class](https:
     *
...
declare module "util/types" {
    ...
    /**
     * Returns `true` if the value is a built-in [`ArrayBuffer`](https:
     * [`SharedArrayBuffer`](https:
     *
    ...
    /**
     * Returns `true` if the value is a built-in [`ArrayBuffer`](https:
     * This does _not_ include [`SharedArrayBuffer`](https:
    ...
    /**
     * Returns `true` if the value is an instance of one of the [`ArrayBuffer`](https:
     * array objects or [`DataView`](https:
     * [`ArrayBuffer.isView()`](https:
     *
     * ```js
    ...
    /**
     * Returns `true` if the value is an [async function](https:
     ...
     *
     * ```js
     * util.types.isBigIntObject(Object(BigInt(123)));   
     * util.types.isBigIntObject(BigInt(123));   
     * util.types.isBigIntObject(123);  
     * ```
     * @since v10.4.0
     */
    ...
    /**
     * Returns `true` if the value is a built-in [`DataView`](https:
     *
     * ```js
     ...
     * ```
     *
     * See also [`ArrayBuffer.isView()`](https:
     * @since v10.0.0
     */
    function isDataView(object: unknown): object is DataView;
    /**
     * Returns `true` if the value is a built-in [`Date`](https:
     *
     * ```js
     ...
     * types.isExternal(data); 
     * types.isExternal(0); 
     * types.isExternal(new String('foo')); 
     * ```
     *
     * For further information on `napi_create_external`, refer to
     * [`napi_create_external()`](https:
     * @since v10.0.0
     */
    function isExternal(object: unknown): boolean;
    /**
     * Returns `true` if the value is a built-in [`Float16Array`](https:
     *
     * ```js
     * util.types.isFloat16Array(new ArrayBuffer());  
     * util.types.isFloat16Array(new Float16Array());  
     * util.types.isFloat16Array(new Float32Array());  
     * ```
     * @since v24.0.0
     */
    function isFloat16Array(object: unknown): object is Float16Array;
    /**
     * Returns `true` if the value is a built-in [`Float32Array`](https:
     *
     * ```js
    ...
    /**
     * Returns `true` if the value is a built-in [`Float64Array`](https:
     *
     * ```js
    ...
    /**
     * Returns `true` if the value is a built-in [`Int8Array`](https:
     *
     * ```js
    ...
    /**
     * Returns `true` if the value is a built-in [`Int32Array`](https:
     *
     * ```js
    ...
    /**
     * Returns `true` if the value is a built-in [`Map`](https:
     *
     * ```js
    ...
    function isMap<T>(
        ...
        : Map<unknown, unknown>;
    /**
     * Returns `true` if the value is an iterator returned for a built-in [`Map`](https:
     *
     * ```js
     * const map = new Map();
    ...
    /**
     * Returns `true` if the value is an instance of a [Module Namespace Object](https:
     *
     * ```js
     ...
     * console.log(util.types.isNativeError(new MyError()));  
     * ```
     *
     * A value being `instanceof` a native error class is not equivalent to `isNativeError()`
     * returning `true` for that value. `isNativeError()` returns `true` for errors
     * which come from a different [realm](https:
     * for these errors:
     *
     * ```js
     ...
     * console.log(types.isNativeError(myError)); 
     ...
     * console.log(util.types.isNativeError(myError)); 
     * console.log(myError instanceof Error); 
     * ```
     * @since v10.0.0
     */
    ...
    /**
     * Returns `true` if the value is a built-in [`Promise`](https:
     *
     * ```js
    ...
    /**
     * Returns `true` if the value is a [`Proxy`](https:
     *
     * ```js
     * const target = {};
    ...
    /**
     * Returns `true` if the value is a built-in [`Set`](https:
     *
     * ```js
    ...
    /**
     * Returns `true` if the value is an iterator returned for a built-in [`Set`](https:
     *
     * ```js
     * const set = new Set();
    ...
    /**
     * Returns `true` if the value is a built-in [`SharedArrayBuffer`](https:
     * This does _not_ include [`ArrayBuffer`](https:
     * desirable to test for both; See `util.types.isAnyArrayBuffer()` for that.
     *
     * ```js
    ...
    /**
     * Returns `true` if the value is a built-in [`TypedArray`](https:
     *
     * ```js
    ...
    /**
     * Returns `true` if the value is a built-in [`Uint8Array`](https:
     *
     * ```js
    ...
    /**
     * Returns `true` if the value is a built-in [`Uint8ClampedArray`](https:
     *
     * ```js
    ...
    /**
     * Returns `true` if the value is a built-in [`Uint16Array`](https:
     *
     * ```js
    ...
    /**
     * Returns `true` if the value is a built-in [`Uint32Array`](https:
     *
     * ```js
    ...
    /**
     * Returns `true` if the value is a built-in [`WeakMap`](https:
     *
     * ```js
    ...
    /**
     * Returns `true` if the value is a built-in [`WeakSet`](https:
     *
     * ```js
