 ...
 *     return err.message === 'Temporary error'; 
 *   }
 * }, apiMethod, function(err, result) {
 *     
 * });
 ...
 * properties, the [ECMAScript Language Specification](http:
 ...
 * [ES2017 `async` function]{@link https:
