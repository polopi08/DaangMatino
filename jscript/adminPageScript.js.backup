...
document.addEventListener('DOMContentLoaded', function() {
    ...
    // Add interaction to the table rows
    const tableRows = document.querySelectorAll('.reports-table tbody tr');
    tableRows.forEach(row => {
        row.addEventListener('click', function() {
            // In a real implementation, this would show detail view
    ...
    async function loadMostReportedRoads() {
        try {
            ...
            if (reportsResult.success) {
                ...
                // Count reports by road/location
    ...
    async function loadAffectedAreas() {
        try {
            ...
            if (reportsResult.success) {
                ...
                // Extract area/municipality from location descriptions
                reportsResult.data.forEach(report => {
                    const location = report.location_description || 'Unknown Area';
                    // Simple area extraction (could be improved with better parsing)
